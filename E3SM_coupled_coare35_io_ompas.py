...
output_dir = '/maloney-scratch2/joedhsu/E3SM_simulation/20211029_mod_coare35_year10.HIST2000_branched_all.A_WCYCL20TRS_CMIP6.ne30_oECv3_ICG.cori-knl/'

for nhist,hist in enumerate(histlist):
    print("Collecting %s data"%hist)
    ds_e3sm_h = E3SM_coare_daily_cori_io_dask(hist=hist,case='coare35_year10',realm='ocn')
