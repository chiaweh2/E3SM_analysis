...
def levitus98(da_var,basin=['all'],reuse_weights=True, 
              newvar=False, lon_name='x',lat_name='y', 
              new_regridder_name='',mask_loc=None):
    """
...
#             regridder_mask.clean_weight_file()
    ...
    if 'atl' in basin:
        ...
        da_mask_atlantic_regrid = \
                  da_mask_atlantic_regrid.where(da_mask_atlantic_regrid.isnull(),other=1.)
